export declare const appRouter: import("@trpc/server").TRPCBuiltRouter<{
    ...
    land: import("@trpc/server").TRPCBuiltRouter<{
        ...
        getAllLandsAdmin: import("@trpc/server").TRPCQueryProcedure<{
            input: {
                status?: "REJECTED" | "AVAILABLE" | "UNVERIFIED" | "IN_NEGOTIATION" | "LEASED" | "HIDDEN" | undefined;
            } | undefined;
            output: any;
            meta: import("trpc-to-openapi").OpenApiMeta;
        }>;
    ...
    escrow: import("@trpc/server").TRPCBuiltRouter<{
        ...
        PayEscrow: import("@trpc/server").TRPCMutationProcedure<{
            ...
            output: {
                ...
                landStatus: "REJECTED" | "AVAILABLE" | "UNVERIFIED" | "IN_NEGOTIATION" | "LEASED" | "HIDDEN";
            };
            meta: import("trpc-to-openapi").OpenApiMeta;
        }>;
    ...
    push: import("@trpc/server").TRPCBuiltRouter<{
        ctx: {
            prisma: import("@prisma/client").PrismaClient<import("@prisma/client").Prisma.PrismaClientOptions, never, import("@prisma/client/runtime/library").DefaultArgs>;
            user: {
                id: string;
